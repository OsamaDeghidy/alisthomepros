...
// Hook لاستخدام Modal انتهاء الجلسة
export function useSessionExpiredModal() {
  ...
  return {
    ...
    showModal,
    hideModal,
    SessionExpiredModal: (props: Omit<SessionExpiredModalProps, 'isOpen' | 'onClose'>) => (
      <SessionExpiredModal {...props} isOpen={isOpen} onClose={hideModal} />
    )
  };
}