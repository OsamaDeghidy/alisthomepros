          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  {...register('rememberMe')}
                  className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:bg-dark-800 dark:border-dark-700"
                />
                <span className="ml-2 text-sm text-dark-700 dark:text-dark-300">Remember me</span>
              </label>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-dark-950 text-gray-500 dark:text-dark-400">Or continue with</span>
              </div>
            </div>
            ...
            {/* Sign Up Link */}
            <div className="text-center">
              <span className="text-dark-600 dark:text-dark-400">Don't have an account? </span>
          ...
          {/* Features */}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-primary-100">All professionals are verified and background checked</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-primary-100">Join over 50,000 professionals and satisfied clients</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-primary-100">Average 4.9-star rating with money-back guarantee</p>
              </div>
            </div>
          </div>
