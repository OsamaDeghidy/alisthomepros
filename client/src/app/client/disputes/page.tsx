...
import { AlertCircle, MessageSquare, FileText, Clock, CheckCircle, XCircle, Plus, Filter, Search } from 'lucide-react';
...
const DisputesPage = () => {
  ...
  const disputeTypes = [
    ...
    { value: 'contract_breach', label: 'خرق العقد' },
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">إدارة ومتابعة النزاعات المتعلقة بمشاريعك</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="اشرح تفاصيل النزاع"
                  rows={4}
                />
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-500">
                          <span>ضد: {dispute.against.first_name} {dispute.against.last_name}</span>
