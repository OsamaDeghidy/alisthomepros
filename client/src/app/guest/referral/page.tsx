...
export default function GuestReferralPage() {
  const videoPlaceholders = [
    { title: 'What is A-List Home Professionals?', duration: '2:15', desc: 'The core vision of South Florida\'s elite home service ecosystem.' },
    { title: 'How to Build Your Network Hub', duration: '3:45', desc: 'A masterclass in connecting professionals and homeowners effectively.' },
    { title: 'The Project Funds Account: Secure & Direct', duration: '2:10', desc: 'How we protect every dollar and every milestone in the network.' }
  ];
  ...
  const steps = [
    ...
    { 
      ...
      color: 'bg-primary-600 text-white shadow-xl shadow-primary-500/20'
    }
  ];
    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900">
      ...
      <section className="bg-gray-950 text-white py-32 px-4 relative overflow-hidden text-center border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
           ...
           <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-none">Your Network <br/><span className="text-primary-400">is Your Net Worth.</span></h1>
               ...
               {videoPlaceholders.map((vid, i) => (
                  <div key={i} className="group">
                     <div className="aspect-video bg-gray-900 rounded-[2.5rem] border border-gray-100 shadow-2xl relative overflow-hidden flex items-center justify-center cursor-pointer mb-6 transform transition-transform duration-500 group-hover:scale-105">
                        <div className="w-16 h-16 bg-white/20 backdrop-blur-xl border border-white/30 rounded-full flex items-center justify-center group-hover:bg-primary-500 group-hover:border-primary-400 transition-all">
         ...
         <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
               <div className="max-w-xl text-center lg:text-left">
                  <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight mb-8">Three Steps <br/>to the <span className="text-primary-500">Gold Standard.</span></h2>
      ...
      <section className="py-32 bg-gray-900 text-white relative overflow-hidden text-center px-4">
            ...
            <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
               <defs>
                  <pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse">
                     <path d="M 10 0 L 0 0 0 10" fill="none" stroke="#00bfff" strokeWidth="0.5" />
                  </pattern>
               </defs>
         ...
         <div className="max-w-4xl mx-auto relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 text-primary-400 rounded-full text-xs font-black uppercase tracking-widest mb-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
               <Link
                  ...
                  target="_blank"
                  className="group relative inline-flex items-center justify-center bg-primary-500 text-white px-16 py-7 rounded-[2.5rem] font-black text-2xl transition-all hover:bg-primary-600 hover:scale-105 active:scale-95 shadow-2xl shadow-primary-500/20"
               >
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-10">
               ...
               <div className="flex items-center gap-2 opacity-50">
                  <Gem className="w-5 h-5 text-primary-400" />
      ...
      <section className="py-24 px-4 text-center bg-white border-t border-gray-100">
         <Heart className="w-12 h-12 text-primary-600 mx-auto mb-8 animate-pulse" />
