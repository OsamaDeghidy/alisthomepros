...
export default function GuestPressPage() {
  const news = [
    {
    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900">
      ...
      <section className="bg-gray-950 text-white py-32 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 pt-10">
           ...
           <p className="text-xl md:text-2xl text-white/60 font-medium max-w-2xl leading-relaxed italic">
          ...
          {news.map((item, i) => (
            <article key={i} className="group border-b border-gray-100 pb-16 last:border-0">
               <div className="flex items-center gap-4 mb-6">
                  <span className="px-4 py-1.5 bg-gray-50 text-gray-900 border border-gray-200 rounded-full text-[10px] font-black uppercase tracking-widest italic">
                    {item.category}
                  </span>
               ...
               <p className="text-xl text-gray-500 font-medium leading-relaxed max-w-4xl mb-8">
                 {item.excerpt}
               </p>
               <Link href={item.url} className="inline-flex items-center gap-3 text-sm font-black text-primary-600 uppercase tracking-widest hover:gap-5 transition-all">
      ...
      <section className="py-24 px-4 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
           ...
           <p className="text-gray-500 text-xl font-medium italic mb-10">Get the latest industry shifts and platform updates delivered directly to your inbox.</p>
