    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900">
      ...
      <section className="py-32 px-4 bg-gray-50 border-y border-gray-100 relative overflow-hidden">
         ...
         <div className="max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-50 text-primary-800 border border-primary-100 rounded-full text-xs font-black mb-12 tracking-widest uppercase italic relative z-10">
               <Shield className="w-4 h-4" />
               Message from the Founder
            </div>
            
            <h2 className="text-5xl md:text-7xl font-black text-gray-950 mb-12 tracking-tighter leading-none relative z-10 italic uppercase pr-4">
            ...
            <div className="space-y-12 text-2xl font-medium text-gray-800 leading-relaxed relative z-10 mt-12 bg-white p-12 md:p-20 rounded-[4rem] shadow-2xl border border-gray-100">
               <p className="text-3xl font-black text-gray-950 tracking-tighter uppercase italic leading-tight pr-4">
               ...
               <div className="pt-16 border-t border-gray-100 flex items-center justify-between">
                  <div>
                     ...
                     <h4 className="text-3xl font-black text-gray-950 tracking-tighter uppercase">— Jeffrey Donald West Jr.</h4>
                  </div>
