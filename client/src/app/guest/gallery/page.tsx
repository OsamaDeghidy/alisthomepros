    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900">
      ...
      <section className="py-32 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-gray-950 mb-8 tracking-tighter leading-none">The Standard <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-success-500">of Excellence.</span></h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {projects.map((project, i) => (
              <div key={i} className="group cursor-pointer">
                <div className="relative aspect-[4/5] rounded-[3.5rem] overflow-hidden mb-8 shadow-2xl transition-all duration-700 group-hover:shadow-[0_40px_80px_-20px_rgba(0,191,255,0.2)] group-hover:-translate-y-4">
                  <Image 
                    src={project.image} 
                    alt={project.title}
                    fill
                  ...
                  <div className="absolute bottom-0 left-0 p-10 w-full">
                    ...
                    <p className="text-white/60 font-medium mb-6 flex items-center gap-2">
                       <MoveRight className="w-4 h-4 text-primary-400" />
                       {project.location}
                    </p>
                    <div className="flex items-center justify-between pt-6 border-t border-white/10">
                       <span className="text-xs font-black text-primary-400 uppercase tracking-widest">{project.stats}</span>
                       <div className="w-10 h-10 bg-white text-gray-950 rounded-xl flex items-center justify-center group-hover:bg-primary-500 transition-colors">
      ...
      <section className="py-32 bg-gray-950 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary-600 rounded-full blur-[200px] opacity-10 translate-x-1/2 -translate-y-1/2"></div>
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 text-primary-400 rounded-full text-xs font-black uppercase tracking-widest mb-8 border border-primary-500/20">
                <UserCheck className="w-4 h-4" />
                Featured Specialist
              </div>
              <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-none">Jeffrey West <br/><span className="text-success-400">Master Finisher.</span></h2>
              ...
              <div className="flex flex-wrap gap-8 mb-16">
                 <div>
                    <h5 className="text-primary-400 font-black text-xs uppercase tracking-widest mb-2">Network Rank</h5>
                    <div className="flex gap-1">
                       {[1,2,3,4,5].map(i => <Star key={i} className="w-4 h-4 fill-primary-400 text-primary-400" />)}
                    </div>
                 </div>
                 <div>
                    <h5 className="text-primary-400 font-black text-xs uppercase tracking-widest mb-2">Verified Since</h5>
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center bg-white text-gray-950 px-12 py-6 rounded-[2rem] font-black text-xl hover:bg-primary-500 hover:text-white transition-all shadow-2xl"
              >
            ...
            <div className="relative">
               <div className="aspect-square bg-white/5 border border-white/10 rounded-[4rem] p-16 flex flex-col justify-center items-center text-center">
                  <Box className="w-24 h-24 text-primary-500 mb-8" />
               ...
               {/* Decorators */}
               <div className="absolute -top-10 -left-10 bg-success-500 p-8 rounded-3xl animate-bounce shadow-2xl">
