      ...
      <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900 pb-32">
         ...
         <section className="bg-gray-950 text-white py-32 px-4 relative overflow-hidden text-center">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
               ...
               <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-none uppercase italic pr-12 overflow-visible">Choose Your <br /><span className="inline-block text-primary-400 pr-10">Place in the Ecosystem.</span></h1>
               <p className="text-xl md:text-2xl text-white/40 font-medium max-w-3xl mx-auto leading-relaxed">
                  Construction works better when everyone is connected. A-List Home Pros brings property owners, Home Pros, crew members, specialists, and opportunities together in one powerful ecosystem.
               </p>
            </div>
         </section>
         ...
         <section className="py-16 bg-gray-950 text-white border-y border-white/10 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
               ...
               <h3 className="text-3xl md:text-5xl font-black mb-8 tracking-tighter uppercase italic pr-12 overflow-visible">
                  Founding membership is <span className="text-primary-400">limited</span> to 1,000 A-List Pros.
               </h3>
