    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900">
      ...
      <section className="bg-gray-950 text-white py-24 px-4 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10">
           ...
           <p className="text-xl md:text-2xl text-white/60 font-medium max-w-2xl italic leading-relaxed pr-4">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20">
           ...
           <div className="lg:col-span-5 space-y-12">
              <div className="space-y-6">
                 <h2 className="text-3xl font-black text-gray-950 tracking-tighter uppercase italic pr-12 overflow-visible">Get the Full Story.</h2>
                 <p className="text-lg text-gray-600 font-medium leading-relaxed italic pr-4">
              ...
              <div className="space-y-8">
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="text-lg text-gray-500 font-bold italic transition-colors pr-4">1-866-882-5478</p>
                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1 italic pr-4">Mon - Fri: 8AM - 6PM EST</p>
                     </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="text-lg text-gray-500 font-bold italic transition-colors pr-4">support@alisthomepros.com</p>
                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1 italic pr-4">24-hour response target</p>
                     </div>
                  </div>
                 ...
                 <div className="p-10 bg-gray-50 rounded-[3rem] border border-gray-100 mt-12 relative overflow-hidden">
                    ...
                    <p className="text-gray-900 font-black italic uppercase tracking-tight relative z-10 leading-tight pr-4">
