    ...
    <div className="bg-[#fcfdff] min-h-screen selection:bg-primary-100 selection:text-primary-900 pb-24">
        ...
        <div className="max-w-4xl mx-auto space-y-20">
           ...
           <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="space-y-6">
                 <h2 className="text-3xl font-black text-gray-950 uppercase pr-12 tracking-tighter italic overflow-visible">Professional Respect</h2>
                 <p className="text-lg text-gray-500 font-medium leading-relaxed italic pr-4">
           ...
           <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="space-y-6">
                 <h2 className="text-3xl font-black text-gray-950 uppercase pr-12 tracking-tighter italic overflow-visible">Integrity & Accountability</h2>
                 <p className="text-lg text-gray-500 font-medium leading-relaxed italic pr-4">
           ...
           <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="space-y-6">
                 <h2 className="text-3xl font-black text-gray-950 uppercase pr-12 tracking-tighter italic overflow-visible">Security Standards</h2>
                 <p className="text-lg text-gray-500 font-medium leading-relaxed italic pr-4">
      ...
      <section className="px-4">
         <div className="max-w-5xl mx-auto bg-gray-50 border border-gray-100 rounded-[4rem] p-16 text-center">
            ...
            <h2 className="text-4xl font-black text-gray-950 mb-6 tracking-tighter uppercase italic pr-12 overflow-visible">Reporting Violations</h2>
            <p className="text-gray-500 text-xl font-medium italic mb-10 max-w-2xl mx-auto pr-4">
