      ...
      <section className="bg-white py-24 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10 pt-10">
           ...
           <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
              <div>
                 <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-50 text-gray-900 border border-gray-200 rounded-full text-[10px] font-black mb-6 tracking-widest uppercase italic pr-4">
      ...
      <section className="px-4">
        <div className="max-w-7xl mx-auto">
              ...
              <article key={i} className="group bg-white rounded-[3rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all overflow-hidden flex flex-col h-full">
                 ...
                 <div className="p-10 flex-1 flex flex-col">
                    <div className="flex items-center justify-between mb-8">
                       <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 border border-gray-100 px-3 py-1 rounded-full italic pr-4">
                         {article.category}
                       </span>
                       <div className="flex items-center gap-2 text-gray-400 text-[10px] font-black uppercase tracking-widest italic pr-4">
                    ...
                    <p className="text-gray-500 font-medium leading-relaxed mb-8 italic pr-4">
                      {article.preview}
                    </p>
                    <div className="mt-auto pt-8 border-t border-gray-50 flex items-center justify-between">
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-widest text-gray-900 italic pr-4">{article.author}</span>
                       </div>
          ...
          <div className="mt-20 text-center">
             <button className="px-12 py-6 bg-gray-950 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-primary-600 transition-all shadow-xl shadow-primary-500/10 italic">
               Load More Articles
             </button>
          </div>
        </div>
